...
class FaultySensorScenario():
    def __init__(self, path_to_data, scenario_id):
    ...
    def __load(self):
        ...
        # Build numpy arrays
        self.Y = labels
        self.X = np.vstack([pressures_per_node[n] for n in self.pressure_nodes] + [flows_per_node[n] for n in self.flow_nodes]).T
